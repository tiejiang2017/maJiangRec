...
void QMaJiangRecBase::getImagesAndLabels()
{
    ...
    QString rootPath="E:/caoXinHua/majiang20171008/maJiangProj/build/";

    printf("procesing bing!!!\n");
    fflush(stdout);
    QString path = rootPath+"bing/";
    int label = 0;
    for(int i=1;i<10;i++)
    {
        label++;

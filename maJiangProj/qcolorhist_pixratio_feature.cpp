...
void QColorHist_PixRatio_Feature::loadModel(QString str)
{
   ...
   // QString str= "/home/cty/workspace/majiang/majiang_case/build/svm_model.xml";
    const string xml = str.toStdString();
   // Ptr<cv::ml::SVM> svm = Algorithm::load<cv::ml::SVM>("my_svm_model.xml");
    //model =cv::ml::SVM::load("/home/cty/workspace/majiang/majiang_case/build/svm_model.xml");
    model = Algorithm::load<cv::ml::SVM>(xml);
}
...
//     waitKey(1);
    ...
    float label = model->predict(imgData);
